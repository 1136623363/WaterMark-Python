(global["webpackJsonp"] = global["webpackJsonp"] || []).push([
  ["pages/clear/clear"], {
    "1d27": function (e, t, o) {
      ...
      o("8d52");
      var i = o("f0c5"),
        s = Object(i["a"])(n["default"], a["b"], a["c"], !1, null, null, null, !1, a["a"], void 0);
      t["default"] = s.exports
    },
    "388f": function (e, t, o) {
      "use strict";
          ...
          r = {
            ...
            data: function () {
              ...
              return e = {
                ...
                percent: 0,
                fileStatus: "success"
              }, (0, i.default)(e, "rewardedVideoAd", null), (0, i.default)(e, "videoType", 0), (0, i.default)(e, "prizeContent", getApp().globalData.prizeContent), (0, i.default)(e, "rewardedVideoAd", null), (0, i.default)(e, "author", getApp().globalData.author), (0, i.default)(e, "cover", null), (0, i.default)(e, "music", null), (0, i.default)(e, "title", null), (0, i.default)(e, "result", !1), (0, i.default)(e, "fileType", 0), (0, i.default)(e, "downLoadType", 1), (0, i.default)(e, "showAd", !1), (0, i.default)(e, "ad", ""), (0, i.default)(e, "adError", 0), (0, i.default)(e, "size", 0), (0, i.default)(e, "playAddr", ""), (0, i.default)(e, "analyseType", 1), (0, i.default)(e, "downLoadType", 2), (0, i.default)(e, "prizeType", getApp().globalData.prizeType), (0, i.default)(e, "type", null), (0, i.default)(e, "flag", null), (0, i.default)(e, "fileUrl", null), (0, i.default)(e, "actionType", 1), (0, i.default)(e, "globalColor", getApp().globalData.globalColor), (0, i.default)(e, "coverList", ["https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=2401491928,907118315&fm=27&gp=0.jpg", "https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=2401491928,907118315&fm=27&gp=0.jpg", "https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=2401491928,907118315&fm=27&gp=0.jpg"]), e
            },
            onLoad: function (e) {
              this.ad = getApp().globalData.toolAd, this.showAd = !0, null != e.link && "undefined" != typeof e.link && (this.textareaAValue = e.link, this.adAnalyse()), null != e.videoMsg && "undefined" != typeof e.videoMsg && (this.videoUrl = e.videoMsg, this.result = !0), this.createRewardVideo(), this.createRewardCard(), null != e.skipType && "undefined" != typeof e.skipType && (this.textareaAValue = getApp().globalData.analyseUrl, this.adAnalyse())
            },
            onShow: function () {},
            ...
            methods: (l = {
              ...
              toSetData: function () {
                ...
                t.actionType = 2, e.getClipboardData({
                  ...
                  fail: function (t) {
                    console.log("============剪切板异常码============="), console.log(t.errno), 1512001 === t.errno ? (console.log(t), e.showModal({
                      title: "提示",
              ...
              videoAnalyse: function () {
                ...
                console.log(t.textareaAValue + "######" + l + "######" + getApp().globalData.token + "######" + t.$source), e.request({
                  ...
                  success: function (o) {
                    if (console.log(o.data), "0002" === o.data.code || "0009" === o.data.code) e.showModal({
                      ...
                      var a = o.data.data;
                      getApp().globalData.title = a.desc, 2 == a.type ? (getApp().globalData.pics = JSON.stringify(a), e.navigateTo({
                        url: "../picInfo/picInfo?initAd=true"
                      })) : (getApp().globalData.playAddr = a.playAddr, getApp().globalData.cover = a.cover, getApp().globalData.title = a.desc, getApp().globalData.size = a.size, t.videoUrl = a.playAddr, t.cover = a.cover, t.title = a.desc, t.music = a.music, t.size = a.size, t.result = !0)
                    } else e.showModal({
              ...
              encrypt: function (e) {
                var t = s.default.enc.Utf8.parse(getApp().globalData.access),
                  o = s.default.enc.Utf8.parse(e),
                  a = s.default.AES.encrypt(o, t, {
              ...
              this.type = e, this.actionType = 1, this.fileUrl = t, console.log(this.$refs.privacyPopup), this.$refs.privacyPopup.proactive(), this.downLoadType = e, this.analyseType = 2
    ...
    a034: function (e, t, o) {
      ...
      var a = {
          cmdProgress: function () {
            return o.e("components/cmd-progress/cmd-progress").then(o.bind(null, "4d36"))
          },
          privacyPopup: function () {
            return o.e("components/privacy-popup/privacy-popup").then(o.bind(null, "ddb0"))
          }
        },
        n = function () {
  ...
  [
    ["388f", "common/runtime", "common/vendor"]
  ]
]);